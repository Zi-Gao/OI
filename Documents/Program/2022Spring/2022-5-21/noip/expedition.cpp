...
int main(){
	...
	for(int i=0;i<N;i++){//Ԥ����һ�£�����һ�� 
		arr[i].first=L-arr[i].first;
	}
	
	sort(arr,arr+N,cmp);//��������һ�� 
	...
	for(int now=P;now<L;){
		while((nowo<N)&&(arr[nowo].first<=now)){//���ߵ���ξ�������м���վ��ջ 
			h.push(arr[nowo++].second);//ֻ��ѽ�������ȥ���У����벻���� 
		}
		if(h.empty()){//û�м���վ�� 
			cnt=-1;
			break;
		}
		now+=h.front();//�������ļ���վȡ���� �ӽ�ȥ 
		h.pop();//********һ��Ҫ��******** ps:�ҵĴ���100���40.... 
		cnt++;//count 
	}
