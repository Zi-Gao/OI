/***
 * @Author: Zi_Gao
 * @Date: 2022-01-23 11:15:00
 * @LastEditTime: 2022-01-23 11:25:38
 * @LastEditors: Zi_Gao
 * @Description: 
 */
#include <string>
...
int main()
{
    freopen("sum_n!.in","r",stdin);
	freopen("sum_n!.out","w",stdout);
    string a,out="0";
    ...
    while(isBigger(a,"1")){
        string t1=a,t2="1";
        while(isBigger(t1,"1")){
            t2=stringMultString(t2, t1);
            t1=stringSubString(t1,"1");
        }
        out=stringAddString(out, t2);
        a=stringSubString(a,"1");
    }
    cout << out ;
    return 0;
}
